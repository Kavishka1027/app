...
function AvailableMedicineItems() {
  ...
  useEffect(() => {
    const fetchSellItems = async () => {
      try {
        const response = await axios.get('http://localhost:3000/api/sellItem/user/availableItem/Medicine');
...
export default AvailableMedicineItems;
